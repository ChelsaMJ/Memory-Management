...
int allocateWorstFit(int process_id, int process_size) {
...
for (int k = worst_fit_index; k < worst_fit_index + process_size; k++) {
memory[k] = process_id;
}
...
int allocation_result = allocateWorstFit(process_id, process_size);
